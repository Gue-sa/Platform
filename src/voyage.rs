...
pub struct Voyage {
    ...
    pub status: VoyageStatus, //0: en cours d'examen, 1: accepté mais pas commencé, 2: en cours, 3: fini, 4: interrompu
...
impl VoyageSegment {
    pub fn new(nav_status: u8, start_p: (u32, u32), end_p: (u32, u32), target_speed: u16) -> Self {
        let distance: u32 = ((start_p.0 as f64 - end_p.0 as f64).powf(2.)
...
impl Voyage {
    pub fn from(voyage_order: VoyageOrder, current_position: (u32, u32)) -> Self {
        let segment: VoyageSegment =
            VoyageSegment::new(0, current_position, voyage_order.destination_position, 0);
