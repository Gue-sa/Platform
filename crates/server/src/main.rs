...
use shared::common::{
    constants::{
        C87B_FROM_SERVER_PORT, C87B_TO_SERVER_PORT, C88B_FROM_SERVER_PORT, C88B_TO_SERVER_PORT, GPS_FROM_SERVER_PORT, GPS_TO_SERVER_PORT,
        SATCOM_FROM_SERVER_PORT, SATCOM_TO_SERVER_PORT,
    },
    types::Channel,
};
use std::thread::park;
...
async fn main() {
    ...
    let freq_satcom: RadioFrequency =
        RadioFrequency::init(Channel::SATCOM, SATCOM_FROM_SERVER_PORT, SATCOM_TO_SERVER_PORT).await;
